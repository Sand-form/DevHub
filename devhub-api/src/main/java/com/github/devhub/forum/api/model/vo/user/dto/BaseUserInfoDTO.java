package com.github.devhub.forum.api.model.vo.user.dto;

import com.github.devhub.forum.api.model.entity.BaseDTO;
...
public class BaseUserInfoDTO extends BaseDTO {
     ...
     * 用户的邮箱
     */
    @ApiModelProperty(value = "用户邮箱", example = "devhub@126.com")
