package com.github.devhub.forum.service.user.service.whitelist;

import com.github.devhub.forum.api.model.enums.user.LoginTypeEnum;
...
import com.github.devhub.forum.api.model.vo.user.ZsxqUserPostReq;
import com.github.devhub.forum.api.model.vo.user.dto.ZsxqUserInfoDTO;
import com.github.devhub.forum.service.user.converter.UserAiConverter;
import com.github.devhub.forum.service.user.converter.UserStructMapper;
...
import com.github.devhub.forum.service.user.service.ZsxqWhiteListService;
...
public class ZsxqWhiteListServiceImpl implements ZsxqWhiteListService {
    ...
    public void reset(Integer authorId) {
        ...
        // 密码重置为
        user.setPassword(userPwdEncoder.encPwd("devhub"));
