package com.github.devhub.forum.service.sidebar.service;

import com.github.devhub.forum.api.model.enums.ConfigTypeEnum;
import com.github.devhub.forum.api.model.enums.SidebarStyleEnum;
import com.github.devhub.forum.api.model.enums.rank.ActivityRankTimeEnum;
...
import com.github.devhub.forum.api.model.vo.rank.dto.RankItemDTO;
import com.github.devhub.forum.api.model.vo.recommend.RateVisitDTO;
import com.github.devhub.forum.api.model.vo.recommend.SideBarDTO;
import com.github.devhub.forum.api.model.vo.recommend.SideBarItemDTO;
...
import com.github.devhub.forum.service.config.service.ConfigService;
import com.github.devhub.forum.service.rank.service.UserActivityRankService;
...
public class SidebarServiceImpl implements SidebarService {
    ...
    private SideBarDTO noticeSideBar() {
        ...
        return new SideBarDTO()
                .setTitle("关于技术派")
                // TODO 知识星球的
                .setImg("https://cdn.tobebetterjavaer.com/devhub/main/devhub-zsxq.jpg")
                .setUrl("https://devhub.com/article/detail/2422000009961473")
                .setItems(items)
    ...
    private SideBarDTO subscribeSideBar() {
        return new SideBarDTO().setTitle("订阅").setSubTitle("楼仔")
                .setImg("//cdn.tobebetterjavaer.com/devhub/a768cfc54f59d4a056f79d1c959dcae9.jpg")
