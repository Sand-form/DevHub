package com.github.devhub.forum.web.front.shortlink.rest;
...
import com.github.devhub.forum.api.model.vo.shortlink.ShortLinkReq;
...
public class ShortLinkController {
    ...
    private QrResource getDefaultLogo() {
        BufferedImage img;
        try {
            img = ImageLoadUtil.getImageByPath(SpringUtil.getConfigOrElse("view.site.websiteFaviconIconUrl", "https://devhub.com/img/icon.png"));
        } catch (Exception e) {
            return null;
        }
