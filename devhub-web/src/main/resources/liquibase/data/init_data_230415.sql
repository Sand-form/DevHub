...
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
VALUES(15, 1, 1, '官宣：技术派上线了！⭐️一款好用又强大的开源社区，学编程，就上技术派?', '', 'https://cdn.tobebetterjavaer.com/devhub/e95f60537f490bb96560aae25e2d53f0.jpg', '一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、MongoDB、Docker、RabbitMQ 等技术栈实现的社区系统，采用主流的互联网技术架构、全新的UI设计、支持一键源码部署，拥有完整的文章&教程发布/搜索/评论/统计流程等，代码完全开源，没有任何二次封装，是一个非常适合二次开发/实战的现代化社区项目? ', 1, 2, '', 1, 0, 0, 1, 0);
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
VALUES(16, 1, 1, '对标大厂的技术派详细方案设计，务必要看', '', 'https://cdn.tobebetterjavaer.com/devhub/7f492cb729d944097d6676b7f19d3ff9.png', '这个项目诞生的背景和企业内生的需求不太一样，主要是某一天二哥说，“我们一起搞事吧”，楼仔问，“搞什么”，然后这个项目的需求就来了言归正传，我们主要的目的是希望打造一个切实可用的项目，依托于这个项目，将java从业者所用到的技术栈真实的展现出来，对于经验不是那么足的小伙伴，可以在一个真实的系统上，理解到自己学习的知识点是如何落地的，同时也能真实的了解一个项目是从0到1实现的全过程系统模块介绍系统架构基于社区系统的分层特点，将整个系统架构划分为展示层，应用层，服务层，如下图展示层其中展示层主要为用', 1, 2, '', 1, 0, 0, 1, 0);
INSERT INTO article
(id, user_id, article_type, title, short_title, picture, summary, category_id, source, source_url, offical_stat, topping_stat, cream_stat, status, deleted)
...
你也可以到技术派的[教程栏（戳这里）](https://devhub.com/column)里阅读，目前正在连载更新中。

![](https://cdn.tobebetterjavaer.com/stutymore/readme-20230410215012.png)

>技术派是一个基于 Spring Boot、MyBatis-Plus、MySQL、Redis、ElasticSearch、MongoDB、Docker、RabbitMQ 等技术栈实现的社区系统，采用主流的互联网技术架构、全新的UI设计、支持一键源码部署，拥有完整的文章&教程发布/搜索/评论/统计流程等，[代码完全开源（可戳）](https://github.com/itwanger/devhub)，没有任何二次封装，是一个非常适合二次开发/实战的现代化社区项目? 。
...
![](https://cdn.tobebetterjavaer.com/devhub/05acc5c76bb87adbb5eb1a3e4e4f5f5c.png)
...
### 技术架构
![](https://cdn.tobebetterjavaer.com/devhub/e0484ed3a9a48b4a3977fccdd7cebcf5.png)
## 系统模块设计
...
![](https://cdn.tobebetterjavaer.com/devhub/5f1dd8c83ce13bfb4f413df27e674246.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/e1ced86bedf29384ec8492519dd4256f.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/8894262819716a1e62c988e752b859d7.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/a98f50b4cdfa7a2a71b7829ed1efe966.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/bd7c10d61a3249edaf9191e7a9733d41.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/e0fa4870e1a19c61dba7b4c8f76de757.png)
开发进度与后期版本迭代计划：
![](https://cdn.tobebetterjavaer.com/devhub/c47c62e298647a98ce96a96ae4270336.png)

## 技术派编程星球

当然了，这些教程会优先开放给[技术派编程星球](https://t.zsxq.com/0buCVQ3qQ)的球友们，毕竟这群家伙都是氪金过的 VIP，一直在等这个项目的官宣，等的嗷嗷叫。

![](https://cdn.tobebetterjavaer.com/devhub/207544feafb505be2dacdf22510de9f6.png)

如果你也想加入技术派的编程星球，现在送出 30 元的优惠券，原价 129 元，等于说优惠完**只需要 99 年就可以加入，每天不到 0.27 元**，超级划算！



![](https://cdn.tobebetterjavaer.com/devhub/2d8158a75714bdba3facaec0ba7b9610.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/0397a6a7eb5b4d8fe3c7ca9a00e76355.png)

**像简历修改，绝不放过任何一个细节**，至今已经修改超过 100 份，所有的简历修改建议也都会第一时间同步到星球里。

![](https://cdn.tobebetterjavaer.com/devhub/77dd551194c05e090b24d0b7b3adfbfd.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/a87da08c67100c0755228c66dbbbf43a.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/61015e67dd9ef8b4a30baaeec0167c05.png)

大厂篇：

![](https://cdn.tobebetterjavaer.com/devhub/50990ffeae270da255ec53116efdb24b.png)

进阶篇：

![](https://cdn.tobebetterjavaer.com/devhub/610fdc02afa49b58854520b836e4ef0d.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/2414cd97c01c934100e8134619d36853.png)

如果你也一样，找楼仔不就得了。。。给大家看看楼仔这几年的学习计划（目前也都放到星球中）：

![](https://cdn.tobebetterjavaer.com/devhub/bb86e1d293c9ec50f224ea0ae26958dc.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/cf240a7981b73afa3969346119387449.png)

对于制定好学习计划的同学，可以在星球中打卡，定期同步学习进度，楼仔也会对你的学习进度进行纠偏哈。

![](https://cdn.tobebetterjavaer.com/devhub/d391ae8331aa97744d33306e8706ca4c.png)

## 04 有价值的资料

星球中会提供大量有价值的学习资料，比如我之前面试大厂的一些笔记，都是我这几年实战的大厂面试题，真枪实弹！就靠这些面试题，拿到过百度、新浪、小米、美团、滴滴、陌陌的 Offer。

![](https://cdn.tobebetterjavaer.com/devhub/9219e1288cc55100380a2846158b337c.png)

星球中还会提供其它大量有价值的学习资料，之前有一部分已经免费发放给大家，但是有一部分属于星球专属。

![](https://cdn.tobebetterjavaer.com/devhub/aff8dce6bb9b894595e7e8b5ca51f0fe.png)

![](https://cdn.tobebetterjavaer.com/devhub/985bd5d963587c9b5aa5d45b4351e84e.png)

## 05 简历&大厂项目文档

马上就到招聘季，我们也会帮大家一起修改简历，大家可以按照这个模板，将改好的简历发给我邮箱，我们会给你简历修改建议，让你能拿到更多面试机会。

![](https://cdn.tobebetterjavaer.com/devhub/2bd598f5fe732055e82f96b7ca89e3f5.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/c485a03da98e567cfcd18aacd329c9ce.png)
...
给大家官宣一件大事，我们搞了近半年的实战项目——[**技术派**](https://devhub.com/)，终于上线了！瞅瞅这首页，清新、高级、上档次！

![](https://cdn.tobebetterjavaer.com/devhub/bdfa153fc82310f9ab862a1b3db0d0d7.png)

瞅瞅我们的文章详情页的楼仔，帅气、文雅，气质拿捏的死死的。

![](https://cdn.tobebetterjavaer.com/devhub/b925179a4afb567c34e09e6117ce1346.png)

文章底部的点赞、留言、文章目录，都是妥妥的细节控。

![](https://cdn.tobebetterjavaer.com/devhub/88c1fb27d5239c8071f70cff6b31ddfa.png)

我们的教程，写得特别用心，这篇《高并发限流》近万字，手绘图也是毫不吝啬。

![](https://cdn.tobebetterjavaer.com/devhub/4fad6764cdff9859d6479326a1ad6c11.png)

[admin 端](https://devhub.com/admin-view)也是开源的，可以对文章/教程进行管理配置，并且加入了游客/管理员账户，方便大家在线体验。

![](https://cdn.tobebetterjavaer.com/devhub/9a2c15310630f172989ac8589ce9702a.png)
...
>- 首页地址：[https://devhub.com](https://devhub.com)
>- GitHub 仓库：[https://github.com/itwanger/devhub](https://github.com/itwanger/devhub)
>- 码云仓库（国内访问更快）：[https://gitee.com/itwanger/devhub](https://gitee.com/itwanger/devhub)
...
![](https://cdn.tobebetterjavaer.com/devhub/3da165adfcad0f03d40e13e941ed4afb.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/d7c691d9c748ba4980fb14b7132929e8.png)

为了做好这个项目，我们付出了巨大的努力。先来看源码，分支 30 个，提交 595 次，这还不包括 admin 端的，已经推出，就广受好评，这才第一周，就收获了 100+ star，这还只是码云上。


![](https://cdn.tobebetterjavaer.com/devhub/ca229cfe9dd66d9733190a32c1622b7c.png)


代码严格按照大厂的规范要求来，组织结构清晰、项目文档齐全、代码注释到位，你想学不到知识都难！

![](https://cdn.tobebetterjavaer.com/devhub/4fb5290e729c6ad7d851d06c09cfd3bc.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/505cf19c993cda5b251b23bbecce2dd0.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/a2e2af3453a677ac69848d72c632cc16.png)

2、库表设计

![](https://cdn.tobebetterjavaer.com/devhub/9d8b1b3ff29736a3a8952cefb6c78a33.png)

3、产品方案

![](https://cdn.tobebetterjavaer.com/devhub/a868cfbf17b57a155d809f9f0ad5b304.png)

4、UI设计

![](https://cdn.tobebetterjavaer.com/devhub/cc0c36ddc05604671c0ab657837c5ca4.png)

5、接口文档

![](https://cdn.tobebetterjavaer.com/devhub/976463cffcb46247f6c6c83425bdf454.png)

6、进度排期

![](https://cdn.tobebetterjavaer.com/devhub/9b09f64bbac80b633da2255896304bfe.png)

7、bug&优化

![](https://cdn.tobebetterjavaer.com/devhub/9dce5d6ed0689e82a8119438de4ffcc7.png)

8、年度复盘

![](https://cdn.tobebetterjavaer.com/devhub/bfbef7833225d5da24ebec60f2f01c9d.png)
...
![](https://cdn.tobebetterjavaer.com/devhub/146e84171eabca58fc7323f309fb4273.png)

然后是基础篇，由二哥来负责。

![](https://cdn.tobebetterjavaer.com/devhub/5ffd29de49299b4cc6f286beba519203.png)

接着是进阶篇，由我们技术派团队的一灰来负责。

![](https://cdn.tobebetterjavaer.com/devhub/ac90ac17e69e0ad0a5b262c6b6b608b2.png)

后面还会推出扩展篇、前端篇、工程篇，把整个 Java 后端的技术栈全部搞定。

![](https://cdn.tobebetterjavaer.com/devhub/c21bc3e9d6e64bfc89ed2ebf5e038478.png)
...
VALUES(1, 5, '高并发手册', 'https://img11.360buyimg.com/ddimg/jfs/t1/159287/38/34144/95370/63c7ee9aFc184be3d/94e07dc5dd5b573f.png', 'https://devhub.com/article/detail/149', '内容肝、配图美、可读性高，高并发经典之作！', 1, 1, '', '{}', 0, '2023-01-13 19:15:57', '2023-04-15 15:05:22');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(2, 1, '加入社区2', 'https://imgs.hhui.top/forum/banner/01.png', 'https://hhui.top/', '', 2, 1, '', '{}', 0, '2023-01-13 19:15:57', '2023-01-13 19:15:57');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(3, 4, '官宣：技术派上线了！', '11', 'https://devhub.com/article/detail/169', '学编程，就上技术派?！', 1, 1, '2', '{}', 0, '2023-01-13 19:15:57', '2023-04-15 14:55:38');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(4, 4, 'Java进阶之路.pdf来了！', ' 2', 'https://devhub.com/column/5/1', '学 Java，就认准二哥的 Java 进阶之路。第一版 PDF 开放下载了！技术派团队出品。', 2, 1, '2', '{}', 0, '2023-01-13 19:15:57', '2023-04-15 16:04:49');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(5, 6, 'JVM 核心手册', ' https://img14.360buyimg.com/ddimg/jfs/t1/184999/39/32111/443189/63c7fbbbF78e720ff/7e878308d3d27dff.png', 'https://devhub.com/article/detail/151', '楼仔原创的 JVM 手册，带你成为 Java 高手！技术派团队出品。', 2, 1, '1', '{"visit":110252,"download":12121,"rate":"9.1"}', 0, '2023-01-13 19:15:58', '2023-04-15 21:23:09');
INSERT INTO config
(id, `type`, name, banner_url, jump_url, content, `rank`, status, tags, extra, deleted, create_time, update_time)
VALUES(6, 6, 'Spring源码解析手册', 'https://img13.360buyimg.com/ddimg/jfs/t1/114223/5/31528/3308443/63c7f65eFdb3a20f2/91c8c191152d82c2.png', 'https://devhub.com/article/detail/150', '楼仔原创的 Spring 源码解读手册，硬核，带你成为 Spring 高手！技术派团队出品。', 2, 1, '1', '{"visit":120248,"download":212103,"rate":"9.3"}', 0, '2023-01-13 19:15:58', '2023-04-15 21:23:09');


update article set summary = '技术派（devhub）是一个前后端分离的 Java 社区实战项目，基于 SpringBoot+MyBatis-Plus 实现，采用 Docker 容器化部署。包括前台社区系统和后台管理系统。前台社区系统包括社区首页、文章推荐、文章搜索、文章发布、文章详情、优质教程、个人中心等模块；后台管理系统包括文章管理、教程管理、统计报表、权限菜单管理、设置等模块。' where id = 1;
